...
from champmetrics.validation.classes.validation_classes import *
from os import path
...
class Dataset_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.dataset import Dataset
    ...
    def test_validate_filenotexist(self):
        from champmetrics.validation.classes.dataset import GIS_Dataset
...
class CHaMP_Raster_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.raster import CHaMP_Raster
...
class CHaMP_Detrended_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.detrended import CHaMP_DetrendedDEM
...
class CHaMP_DEM_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.dem import CHaMP_DEM
...
class CHaMP_PointDensity_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.assoc_point_density import CHaMP_Associated_PointDensity
...
class CHaMP_PointQuality_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.assoc_3d_point_quality import CHaMP_Associated_3DPointQuality
...
class CHaMP_Assoc_Slope_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.assoc_slope import CHaMP_Associated_Slope
...
class CHaMP_Assoc_Roughness_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.assoc_roughness import CHaMP_Associated_Roughness
...
class CHaMP_Assoc_InterpolationError_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.assoc_interpolation_error import CHaMP_Associated_InterpolationError
...
class CHaMP_ErrorSurface_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.error_surface import CHaMP_ErrorSurface
...
class CHaMP_WaterSurfaceDEM_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.water_surface_dem import CHaMP_WaterSurfaceDEM
...
class CHaMP_WaterDepth_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.waterdepth import CHaMP_WaterDepth
...
class CHaMP_Vector_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.vector import CHaMP_Vector
...
class CHaMP_VectorPoint_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.vector import CHaMP_Vector_Point
...
class CHaMP_VectorPoint3D_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.vector import CHaMP_Vector_Point_3D
...
class CHaMP_TopoPoints_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.topo_points import CHaMP_TopoPoints
...
class CHaMP_EdgeofWaterPoints_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.edgeofwater_points import CHaMP_EdgeofWater_Points
        from champmetrics.lib.raster import get_data_polygon
...
class CHaMP_StreamFeatures_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.streamfeature_points import CHaMP_StreamFeature_Points
...
class CHaMP_ControlPoints_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.control_points import CHaMP_ControlPoints
...
class CHaMP_Error_Points_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.error_points import CHaMP_Error_Points
...
class CHaMP_Polyline_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.vector import CHaMP_Vector_Polyline
...
class CHaMP_Breaklines_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.breaklines import CHaMP_Breaklines
        from champmetrics.validation.classes.vector import CHaMP_Vector_Point_3D
...
class CHaMP_Polyline_LongLines_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.vector import CHaMP_Vector_Polyline_LongLine
        from champmetrics.validation.classes.water_extent import CHaMP_WaterExtent
        from champmetrics.validation.classes.islands import CHaMP_Islands
        from champmetrics.lib.raster import get_data_polygon
...
class CHaMP_Thalweg_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.thalweg import CHaMP_Thalweg
        from champmetrics.validation.classes.topo_points import CHaMP_TopoPoints
        from champmetrics.lib.raster import get_data_polygon
...
class CHaMP_Centerline_Class(unittest.TestCase):
    ...
    def test_validate_Wetted(self):
        from champmetrics.validation.classes.centerline import CHaMP_Centerline
        from champmetrics.validation.classes.thalweg import CHaMP_Thalweg
        from champmetrics.lib.raster import get_data_polygon
...
class CHaMP_CrossSection_Class(unittest.TestCase):
    def test_validate_Wetted(self):
        from champmetrics.validation.classes.cross_sections import CHaMP_CrossSections
...
class CHaMP_Polygon_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.vector import CHaMP_Polygon
...
class CHaMP_ChannelUnits_Class(unittest.TestCase):
    ...
    def test_validate(self):
        from champmetrics.validation.classes.channel_units import CHaMP_ChannelUnits
        from champmetrics.validation.classes.water_extent import CHaMP_WaterExtent
...
class CHaMP_Survey_Class(unittest.TestCase):
    ...
    """
    def test_validate(self):
        from champmetrics.validation.champ_survey import CHaMPSurvey
        survey = CHaMPSurvey()
        ...
        for results_dataset in results.values():
            for result in results_dataset:
                # TODO: I've lost the plot and I don't really know what this is supposed to test
                self.assertIn(result['Status'], ["Error", "Warning", "NotTested"], " ".join([v for v in result.values()]))
