...
def uploadProjectToRiverscapes(dirpath, invVisit):
    from riverscapeschampmetrics.s3.operations import S3Operation
    from riverscapeschampmetrics.s3.walkers import s3BuildOps
    from riverscapeschampmetrics.program import Program
    from riverscapeschampmetrics.program import Project
    from riverscapeschampmetrics.settings import defaults
